<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('dashboard') }}">
            ...
            <span class="ms-1 font-weight-bold">Clerance System</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @can('manage-roles')
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'role-permission' ? 'active' : '' }}"
            ...
            @endcan
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Other tools</h6>
            </li>
            @can('sing-clerance')
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'requests' ? 'active' : '' }}" href="{{ route('requests') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Clerance requests</span>
                </a>
            </li>
            @endcan
            
            @can('request-clereance')
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'request.clerance' ? 'active' : '' }}"
                    href="{{ route('request.clerance') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Clearnce</span>
                </a>
            </li>
            @endcan
    ...
    <div class="sidenav-footer mx-3 mt-3 pt-3">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-left p-3 w-100">
                ...
                <div class="docs-info">
                    <h6 class="text-white up mb-0">Need clerance?</h6>
                    <p class="text-xs font-weight-bold">Please check your eligibility</p>
                    <a href="{{route('request.clerance')}}"
                        class="btn btn-white btn-sm w-100 mb-0">Request clerance</a>
                </div>
            </div>
        </div>
    </div>
