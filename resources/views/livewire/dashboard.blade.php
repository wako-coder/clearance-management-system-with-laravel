      ...
      <div class="row mb-3">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    <h5 class="font-weight-bolder">ARSI University Clerance system</h5>
                    <p class="mb-5">From papers, cards, and manual things, you will find easy way to ask and get clearnce.</p>
        ...
        <div class="col-lg-5">
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../images/arsi.jpg');">
              <span class="mask bg-gradient-dark"></span>
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                <h5 class="text-white font-weight-bolder mb-4 pt-2">Learn in Arsi</h5>
                <p class="text-white">To day Arsi university college of social science and humanity , Bokoji Campus freshman students well come ceremony and orientation were given for 2014 E.C ...</p>
